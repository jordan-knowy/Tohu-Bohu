...
function base(): HomeDashboardData {
  return {
    ...
    priorityActions: [
      { actionId: 'relance:p4', type: 'relance', title: 'Silence prolongé — relancer Fixture Delta', explanation: '41 j sans contact · score 39. Reprends langue avant que la relation ne refroidisse.', priority: 84, accountId: 'p4', accountName: 'Fixture Delta', personId: null, personName: null, source: 'Historique des interactions', observedAt: iso(41), confidence: 90, sourceSignalId: null, recommended: 'Reprendre contact cette semaine', sourceUrl: null, sourceExcerpt: null, sourceOccurredAt: null, sourceDirection: null },
      { actionId: 'mouvement:sig1', type: 'mouvement', title: 'Nouveau décideur — à confirmer', explanation: 'Un contact connu apparaît sous un nouveau rôle (fixture, 1 source).', priority: 76, accountId: 'p1', accountName: 'Fixture Alpha', personId: null, personName: null, source: 'LinkedIn', observedAt: iso(3), confidence: 55, sourceSignalId: 'sig1', recommended: 'Confirmer le mouvement', sourceUrl: 'https://www.linkedin.com/in/fixture-contact', sourceExcerpt: null, sourceOccurredAt: null, sourceDirection: null },
      { actionId: 'couverture:p2', type: 'couverture', title: 'Un seul interlocuteur chez Fixture Bravo', explanation: 'La relation repose sur une seule personne : élargis la couverture.', priority: 62, accountId: 'p2', accountName: 'Fixture Bravo', personId: null, personName: null, source: 'Couverture des contacts', observedAt: iso(0), confidence: 85, sourceSignalId: null, recommended: 'Identifier un second contact', sourceUrl: null, sourceExcerpt: null, sourceOccurredAt: null, sourceDirection: null },
      { actionId: 'validation:sig2', type: 'validation', title: 'À valider : échéance détectée', explanation: 'Signal à confiance limitée (fixture).', priority: 41, accountId: 'p5', accountName: 'Fixture Echo', personId: null, personName: null, source: 'BODACC', observedAt: iso(6), confidence: 45, sourceSignalId: 'sig2', recommended: 'Confirmer ou infirmer', sourceUrl: null, sourceExcerpt: null, sourceOccurredAt: null, sourceDirection: null },
      { actionId: 'engagement:c1', type: 'engagement', title: 'Engagement à tenir — Envoyer le devis mis à jour', explanation: 'Promis dans les échanges avec Contact Fixture. Toujours ouvert.', priority: 55, accountId: 'p3', accountName: 'Fixture Charlie', personId: 'per1', personName: 'Contact Fixture', source: 'Tohu · engagement détecté', observedAt: iso(5), confidence: 88, sourceSignalId: null, recommended: 'Faire avancer cet engagement', sourceUrl: null, sourceExcerpt: 'Je préfère attendre la validation du budget avant d’avancer.', sourceOccurredAt: iso(5), sourceDirection: 'inbound' },
    ],
    latestSignals: [
      { id: 'sig1', kind: 'behavioral', signalType: 'mobility', title: 'Mouvement de poste détecté', summary: 'Un contact apparaît sous un nouveau rôle (fixture).', accountId: 'p1', accountName: 'Fixture Alpha', personId: 'per1', personName: 'Contact Fixture', source: 'LinkedIn', observedAt: iso(3), confidence: 55, inferenceLevel: 'inferred', userVerdict: null, sourceUrl: 'https://www.linkedin.com/in/fixture-contact' },
      { id: 'sig2', kind: 'company', signalType: 'risque', title: 'Échéance approche', summary: 'Fenêtre de décision sous 60 j (fixture).', accountId: 'p5', accountName: 'Fixture Echo', personId: null, personName: null, source: 'BODACC', observedAt: iso(6), confidence: 82, inferenceLevel: 'observed', userVerdict: null, sourceUrl: null },
      { id: 'sig3', kind: 'company', signalType: 'mobilite', title: 'Changement de gouvernance', summary: 'Le décideur historique n’est plus seul à trancher (fixture).', accountId: 'p4', accountName: 'Fixture Delta', personId: null, personName: null, source: 'Presse', observedAt: iso(12), confidence: 48, inferenceLevel: 'inferred', userVerdict: 'confirmed', sourceUrl: null },
      { id: 'sig4', kind: 'behavioral', signalType: 'recent_activity', title: 'Reprise de contact', summary: 'Un contact reprend langue (fixture).', accountId: 'p2', accountName: 'Fixture Bravo', personId: 'per2', personName: 'Autre Fixture', source: 'Outlook', observedAt: iso(15), confidence: 74, inferenceLevel: 'observed', userVerdict: null, sourceUrl: null },
      { id: 'sig5', kind: 'company', signalType: 'croissance', title: 'Actualité sectorielle', summary: 'Fixture — actualité liée au compte.', accountId: 'p3', accountName: 'Fixture Charlie', personId: null, personName: null, source: 'Presse', observedAt: iso(18), confidence: 60, inferenceLevel: 'observed', userVerdict: null, sourceUrl: 'https://presse.example.com/fixture-actualite' },
      { id: 'sig6', kind: 'company', signalType: 'presence', title: 'Silence prolongé', summary: '41 j sans contact (fixture).', accountId: 'p4', accountName: 'Fixture Delta', personId: null, personName: null, source: 'Historique', observedAt: iso(1), confidence: 90, inferenceLevel: 'observed', userVerdict: null, sourceUrl: null },
      { id: 'sig7', kind: 'company', signalType: 'levier', title: '1 an de relation', summary: 'Occasion de consolider (fixture).', accountId: 'p1', accountName: 'Fixture Alpha', personId: null, personName: null, source: 'Historique', observedAt: iso(20), confidence: 95, inferenceLevel: 'observed', userVerdict: null, sourceUrl: null },
    ],
    coaching: {
