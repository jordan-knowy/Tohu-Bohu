...
const connectors: Connector[] = [
  { provider: 'google', databaseProvider: 'google', label: 'Google Workspace', detail: 'Gmail, Agenda, Meet et Chat', icon: GOOGLE_ICON, identity: 'google', scopes: 'https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/meetings.space.readonly https://www.googleapis.com/auth/chat.spaces.readonly https://www.googleapis.com/auth/chat.messages.readonly' },
