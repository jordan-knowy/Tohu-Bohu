...
- "approach_guidance" : 2 à 4 scénarios CONCRETS et CONTEXTUELS indiquant comment aborder AU MIEUX cette personne, déduits UNIQUEMENT des preuves observées (jamais un conseil générique applicable à n'importe qui). Chaque scénario : "context" = une situation précise et variée ("Avant un rendez-vous", "Par email", "Quand il/elle temporise ou hésite", "Pour obtenir une décision", "Après un désaccord ou une friction", "Pour embarquer sur un nouveau sujet"…) ; "summary" = une phrase expliquant le levier relationnel PROPRE à cette personne dans ce contexte, avec le groupe de mots le plus décisif entouré de ** ** (ex. "Il **structure sa pensée en parlant**, laisse-le dérouler.") — un seul passage souligné par phrase, jamais toute la phrase ; "do" = EXACTEMENT 3 actions précises qui fonctionnent avec elle, ancrées sur son style réel (rythme, registre, argumentation, engagement…) et cohérentes avec les axes ci-dessus ; "dont" = EXACTEMENT 3 pièges concrets à éviter avec elle. Si les preuves ne suffisent pas pour justifier 3 items distincts et réellement ancrés sur cette personne, complète avec des leviers déduits raisonnablement des axes déjà mesurés plutôt que de répéter ou d'inventer un fait — jamais moins de 3, jamais un doublon. Formulation opérationnelle (impératif), directement utile avant de la contacter ou de la voir. Renvoie une liste vide de scénarios si les preuves sont insuffisantes pour être pertinent.
...
Réponds uniquement avec ce JSON strict :
{
  ...
  "cognitive_profile_data": {
    ...
    "approach_guidance": [{"context":"Avant un rendez-vous","summary":"phrase ancrée sur son style ou null","do":["action précise 1","action précise 2","action précise 3"],"dont":["piège à éviter 1","piège à éviter 2","piège à éviter 3"]}]
  }
}
