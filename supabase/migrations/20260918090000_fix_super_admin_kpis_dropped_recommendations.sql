-- account_recommendations / person_recommendations ont été supprimées (hors suivi de
-- migration, cf. incident du 2026-09-10) mais get_super_admin_kpis() les référence
-- encore, ce qui fait échouer getSuperAdminData() côté front et bloque l'accès au
-- mode Super Admin sur un écran de chargement infini.
